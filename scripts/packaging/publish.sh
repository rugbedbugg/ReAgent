...
if [[ "$CHANNEL" == aur ]]; then
    ...
    git clone ssh://aur@aur.archlinux.org/reagent.git submission
    cd submission
    ...
    git commit -S -m "[Packaging]: Update reagent to $VERSION"
    ...
    branch="packaging/reagent-$VERSION"
