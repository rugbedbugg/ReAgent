...
OBJECTIVE_BRIEFS: dict[str, str] = {
    ...
    "safety": (
        ...
        "Decisive fact: hazard_count and distinct_hazards.\n"
        "Rubric (use these EXACT values): hazard_count 0 -> score 1.0; hazard_count 1 "
        "-> 0.5; each additional distinct hazard subtracts 0.1 with a floor of 0.1 "
        "(2 -> 0.4, 3 -> 0.3). Examples: {hazard_count:0, distinct_hazards:[]} -> 1.0; "
        "{hazard_count:1, distinct_hazards:['acid_halide']} -> 0.5; "
        "{hazard_count:2, distinct_hazards:['nitro','alkyl_halide']} -> 0.4. Cite "
        "hazard_count and distinct_hazards."
    ),
    "sustainability": (
